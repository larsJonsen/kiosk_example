defmodule KioskExampleWeb.Components.Button do
  @moduledoc """
  Provides a comprehensive set of button components for the `KioskExampleWeb.Components.Button` project.
  ...
  import KioskExampleWeb.Components.Icon, only: [icon: 1]
